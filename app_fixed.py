    ...
    try:
        ...
        try:
            ...
            if "relation" in str(e) and "does not exist" in str(e):
                logger.warning("Calls table doesn't exist, creating...")
                try:
                    # Create table using Supabase SQL editor would be better
                    # For now, just log and continue
                    logger.warning("Please create 'calls' table in Supabase")
                except:
                    pass
            else:
...
if __name__ == "__main__":
    ...
    logger.info(f"Starting MCP Call Analyzer v2.1 on port {port}")
